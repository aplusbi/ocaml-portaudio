...
(** Write to a stream. *)
val write_stream : stream -> (float, Bigarray.float32_elt, Bigarray.c_layout) Bigarray.Array2.t -> int -> int -> unit

(** Read from a stream. *)
val read_stream : stream -> (float, Bigarray.float32_elt, Bigarray.c_layout) Bigarray.Array2.t -> int -> int -> unit
